...
bool OmniShadowMap::Init(GLuint width, GLuint height) {
    ...
    glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, interpolationMethod);
    glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAG_FILTER, interpolationMethod);
